...
<div class="bloc bgc-gainsboro tc-liver l-bloc" id="bloc-22">
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center order-lg-1 order-md-1"><img src="{{ asset('public/landing/img/pngguru.com%20%281%29.png')}}" class="img-fluid mx-auto d-block" alt="pngguru.com%20(1)" /></div>
...
<div class="bloc bgc-gainsboro none bg-gradient tc-white l-bloc" id="bloc-16">
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center col-lg-6 offset-lg-0 order-lg-0"><img src="{{ asset('public/landing/img/hyundai_hd120.png')}}" class="img-fluid mx-auto d-block" alt="pngguru.com%20(1)" /></div>
            <div class="align-self-center col-md-6">
    ...
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center col-lg-6 offset-lg-0 order-lg-1">
                <img src="{{ asset('public/landing/img/cattle%20truck.png') }}" class="img-fluid mx-auto d-block" alt="pngguru.com%20(1)" />
            </div>
            <div class="align-self-center col-md-6">
    ...
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center order-lg-0 order-md-0">
                <img src="{{ asset('public/landing/img/pickup-reefer.png') }}" class="img-fluid mx-auto d-block" alt="kindpng_227210" />
            </div>
            <div class="align-self-center col-md-6">
...
<div class="bloc bgc-gainsboro tc-liver l-bloc" id="bloc-21">
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center order-lg-1 order-md-1"><img src="{{ asset('public/landing/img/nissan_urvan.png') }}" class="img-fluid mx-auto d-block" alt="pngguru.com%20(1)" /></div>
...
<div class="bloc bgc-gainsboro bg-gradient tc-white l-bloc" id="bloc-22">
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center order-lg-1 order-md-0"><img src="{{ asset('public/landing/img/dmax_doubledoor.png') }}" class="img-fluid mx-auto d-block" alt="kindpng_227210" /></div>
...
<div class="bloc bgc-gainsboro tc-liver l-bloc" id="bloc-26">
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 order-md-1 align-self-center order-lg-1"><img src="{{ asset('public/landing/img/Isuzu_D-Max_Mk2f_SingleCab_Ute_SX.png') }}" class="img-fluid mx-auto d-block" alt="kindpng_227210" /></div>
            <div class="align-self-center col-md-6">
...
<div class="bloc bgc-gainsboro bg-gradient tc-white l-bloc" id="bloc-27">
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center order-lg-0 order-md-0"><img src="{{ asset('public/landing/img/Dokker.png') }}" class="img-fluid mx-auto d-block" alt="kindpng_227210" /></div>
            <div class="align-self-center col-md-6">
...
<div class="bloc bgc-gainsboro tc-liver l-bloc" id="bloc-23">
    <div class="container bloc-lg">
        <div class="row">
            <div class="col-md-6 align-self-center order-md-0 order-lg-1"><img src="{{ asset('public/landing/img/hyundai_20accentltdsd5a_angularfront_frostwhitepearl.png') }}" class="img-fluid mx-auto d-block" alt="kindpng_227210" /></div>
            <div class="align-self-center col-md-6">
