...
<html lang="ar">
	<head>
		...
		<link rel="stylesheet" href="{{ asset('public/landing/css/animate.min.css') }}">
		<link rel="stylesheet" href="{{ asset('public/landing/css/boxicons.min.css') }}"> 
		...
		<link rel="stylesheet" href="{{ asset('public/landing/css/meanmenu.min.css') }}">
		<link rel="stylesheet" href="{{ asset('public/landing/css/nice-select.min.css') }}">
		<link rel="stylesheet" href="{{ asset('public/landing/css/odometer.min.css') }}">
		<link rel="stylesheet" href="{{ asset('public/landing/css/style.css?v=dasdasd') }}">
		<link rel="stylesheet" href="{{ asset('public/landing/css/responsive.css') }}">
		<link rel="icon" type="image/png" href="{{ asset('public/wtc_logo_gray.png') }}">
    ...
    <body>
				...
				<div class="mobile-nav">
					<div class="container">
						<div class="mobile-menu">
							<div class="logo">
								<a href="{{ url('/')}}">
									<img src="{{ asset('public/wtc_logo_gray.png') }}" height="45" width="50" alt="Helpway">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<nav class="navbar navbar-expand-md navbar-light">
							<a class="navbar-brand" href="{{ url('/')}}">
								<img src="{{ asset('public/wtc_logo_gray.png') }}" height="45" width="100" alt="Helpway">
							</a>
								...
								<ul class="navbar-nav m-auto">
									...
									<li class="nav-item">
										<a href="#" class="nav-link active">
											<img src="{{ asset('public/assets/img/'.LaravelLocalization::getCurrentLocale().'.png') }}" height="20" width="20" alt=""> 
					...
					<div class="col-lg-12 col-md-12">
						<div class="single-footer-widget">
							<a href="{{ url('/')}}" class="logo">
								<img src="{{ asset('public/wtc_logo_gray.png') }}" height="50" width="200" alt="Image">
							</a>
		...
		<script src="{{ asset('public/landing/js/meanmenu.min.js') }}"></script>
        <script src="{{ asset('public/landing/js/wow.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/owl.carousel.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/nice-select.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/magnific-popup.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/parallax.min.js') }}"></script>
        <script src="{{ asset('public/landing/js/appear.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/odometer.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/smoothscroll.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/ajaxchimp.min.js') }}"></script>
		<script src="{{ asset('public/landing/js/custom.js?v=ss') }}"></script>
    </body>
</html>