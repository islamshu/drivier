...
@section('buttons')
    ...
    <a class="btn purple" data-toggle="modal" href="#importCustomers"> <i class="fa fa-upload font-white" ></i> </a>

    <div id="importCustomers" class="modal fade" tabindex="-1" data-width="760">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            <h4 class="modal-title">Import Customers</h4>
        </div>
        <form action="{{ url(route('admin.customer.import'))}}" enctype="multipart/form-data" method="POST" >
            @csrf
