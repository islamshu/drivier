...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('public/assets/layouts/layout/css/layout.css?=0')}}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('public/assets/layouts/layout/css/themes/darkblue.css')}}" rel="stylesheet" type="text/css" id="style_color" />
    ...
    <body class="page-header-fixed page-sidebar-closed page-content-white page-sidebar-fixed page-md">
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="{{ url('admin')}}">
                            <img src="{{ asset('public/assets/layouts/layout/img/logolight.jpeg')}}" alt="logo" class="logo-default" /> </a>
                                    ...
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('public/assets/pages/img/avatars/team2.jpg')}}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('public/assets/pages/img/avatars/team4.jpg')}}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{ asset('public/assets/pages/img/avatars/team3.jpg')}}" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                                        <span class="from"> Richard Doe </span>
                                ...
                                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="{{ asset('public/assets/pages/img/avatars/team4.jpg')}}" alt="...">
                                    ...
                                    <ul class="media-list list-items">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="{{ asset('public/assets/pages/img/avatars/team2.jpg')}}" alt="...">
                                            <div class="media-body">
                                ...
                                <div class="page-quick-sidebar-item">
                                    <div class="page-quick-sidebar-chat-user">
                                        ...
                                        <div class="page-quick-sidebar-chat-user-messages">
                                            <div class="post out">
                                                <img class="avatar" alt="" src="{{ asset('public/assets/pages/img/avatars/team4.jpg')}}" />
                                                <div class="message">
                                            ...
                                            <div class="post in">
                                                <img class="avatar" alt="" src="{{ asset('public/assets/pages/img/avatars/team3.jpg')}}" />
                                                <div class="message">
                                                    <span class="arrow"></span>
                                                    <a href="javascript:;" class="name">Ella Wong</a>
        ...
        <script src="{{ asset('public/assets/layouts/layout/scripts/layout.js')}}" type="text/javascript"></script>
        <script src="{{ asset('public/assets/layouts/layout/scripts/demo.js')}}" type="text/javascript"></script>
