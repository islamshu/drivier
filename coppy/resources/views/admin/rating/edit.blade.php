            ...
            <div class="widget-content widget-content-area">
                <form action="{{ url(route('questionair.store'))}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="question_ar" placeholder="@lang('app.question_ar')" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>@lang('app.question_en')</label>
                        <input type="text" name="question_en" placeholder="@lang('app.question_en')" class="form-control">
                    </div>
                    <div class="form-group">
