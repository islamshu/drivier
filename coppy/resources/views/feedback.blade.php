...
<link href="{{ asset('public/assets/css/design-css/design-icons.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('public/assets/css/components/custom-rating.css')}}" rel="stylesheet" type="text/css">
@endsection
...
<script src="{{ asset('public/assets/js/components/custom-rating.js')}}"></script>
