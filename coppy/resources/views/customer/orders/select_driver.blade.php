...
@section('header')
<link href="{{ asset('public/plugins/loaders/csspin.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ asset('public/plugins/loaders/custom-loader.css')}}" rel="stylesheet" type="text/css" />
<style>
    .createorder {
        height: 300px;
    }
