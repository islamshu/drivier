    ...
    <div class="col-lg-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form action="{{ url(route('customer.order.update' , [$order->id]))}}" method="POST">
                    @csrf
...
<script src="{{ asset('public/plugins/input-mask/input-mask.js?v=1') }}"></script>
<script src="{{ asset('public/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js')}}"></script>
<script src="{{ asset('public/plugins/bootstrap-touchspin/custom-bootstrap-touchspin.js?v=2')}}"></script>
