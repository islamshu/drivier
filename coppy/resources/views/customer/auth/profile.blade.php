    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{ url(route('customer.update', [$customer->id]))}}" method="POST">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control" value="{{ $customer->name }}" name="name" placeholder="@lang('app.name')">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" value="{{ $customer->email }}" name="email" placeholder="@lang('app.email')">
                            </div>
                            <button type="submit" class="btn btn-classic btn-primary">@lang('app.save')</button>
                        </form>
                    </div>
                    <div class="col-md-6">
                        <form action="{{ url(route('customer.password.change'))}}" method="POST">
                            @csrf
                            <div class="form-group">
