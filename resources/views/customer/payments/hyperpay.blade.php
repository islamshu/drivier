                    ...
                    <div class="tab-pane fade show active" id="justify-pills-home" role="tabpanel" aria-labelledby="justify-pills-home-tab">
                        <div class="row col-sm-50 col-50">
                            <div class="col-sm-1 col-12">
                                <div>
                                    <img class="fit-image" src="{{ asset('assets/img/mada.png')}}" width="105px" height="55px">
                                </div>
                            </div>
                            <div class="col-sm-1 col-12">
                                <div>
                                    <img class="fit-image" src="{{ asset('assets/img/visa.jpg')}}" width="105px" height="55px"> 
                                </div>
                            </div>
                            <div class="col-sm-1 col-12">
                                <div>
                                    <img class="fit-image" src="{{ asset('assets/img/master.jpg') }}" width="105px" height="55px">
                                </div>
                            </div>
                            <div class="col-sm-1 col-12">
                                <div>
                                    <img class="fit-image" src="{{ asset('assets/img/amex.png')}}" width="105px" height="55px">
                                </div>
                            </div>
                            <div class="col-sm-1 col-12">
                                <div>
                                    <img class="fit-image" src="{{ asset('assets/img/stc.png')}}" width="105px" height="55px">
                                </div>
                            </div>
