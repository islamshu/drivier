...
<head>
    ...
    <link href="{{ asset('assets/css/users/register-2.css?v=3')}}" rel="stylesheet" type="text/css" />
    ...
    <form class="form-register" action="{{ url(route('company.signup'))}}" method="POST">
        ...
        <div class="row">
            <div class="col-md-12 text-center mb-4">
                <img alt="logo" width="200" height="150" src="{{ asset('wtc_logo_gray.png')}}" class="theme-logo img-fluid">
            </div>
            @include('message')
            <br>
