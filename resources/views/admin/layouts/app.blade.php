...
<head>
    ...
    @endif
    @yield('header')
    <link href="{{ asset('assets/css/plugins.css?v=88')}}" rel="stylesheet" type="text/css" />
    <style>
        .navbar-brand {
            width: 7.5rem;
        ...
        <ul class="nav navbar-nav">
            <li class="nav-item d-lg-none"> 
                <a href="{{ url(route('admin.dashboard'))}}" class=""> 
                    <img alt="logo"  src="{{ asset('wtc_logo_gray.png')}}" class="img-fluid">
                </a>
            </li>
        </ul>
    </header>
        ...
        <ul class="navbar-nav flex-row">
            <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="flagDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ asset('assets/img/'.LaravelLocalization::getCurrentLocale().'.png') }}" alt=""> <span class="d-lg-inline-block d-none"></span>
                </a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item d-flex">
                        <a href="{{ url(route('admin.dashboard'))}}" class="navbar-brand">
                            <img src="{{ asset('wtc_logo_gray.png')}}" class="theme-logo" width="250" alt="logo">
                        </a>
                    </li>
                </ul>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.count != 0) {
                            ...
                            $notify = "{{ asset('sound/notifyy.mp3')}}";
