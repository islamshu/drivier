...
<link href="{{ asset('assets/css/ui-kit/tabs-accordian/custom-accordions.css')}}" rel="stylesheet" type="text/css" />
...
@push('script')
<script src="{{ asset('assets/js/ui-kit/ui-accordions.js')}}"></script>
