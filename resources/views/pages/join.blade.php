...
<div class="bloc l-bloc" id="bloc-27">
    <div class="container bloc-md">
        <div class="row">
            <div class="col-md-4"><img src="{{ asset('landing/img/restaurant.png') }}" class="img-fluid mx-auto d-block" alt="restaurant" /></div>
            <div class="col-md-4"><img src="{{ asset('landing/img/Pharmacy.png') }}" class="img-fluid mx-auto d-block" alt="Pharmacy" /></div>
            <div class="col-md-4"><img src="{{ asset('landing/img/warehouse.png') }}" class="img-fluid mx-auto d-block" alt="warehouse" /></div>
        </div>
    </div>
</div>
<!-- bloc-27 END -->
