...
<div class="bloc bg-maps d-bloc" id="bloc-20">
    <div class="container bloc-sm">
        <div class="row">
            <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2"><img src="{{ asset('landing/img/Asset%204.svg')}}" class="img-fluid mx-auto d-block" alt="stock photo-several-cars-vans-trucks-parked-in-parking-lot-for-rent-or-delivery-1251741952" /></div>
        </div>
    </div>
</div>
<!-- bloc-20 END -->
    ...
    <div class="container bloc-md">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 order-lg-0 order-md-0 offset-md-3 col-md-6 offset-lg-0 col-sm-8 offset-sm-2 order-sm-0 align-self-center">
                <img src="{{ asset('landing/img/iphone_mockup_2.png') }}" class="img-fluid mx-auto d-block img-iphone-mockup-style" alt="wtc_iphone_mockup" />
            </div>
